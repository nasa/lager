...
if(MSVC)
  if (EXISTS "$ENV{ZeroMQ_ROOT_DIR}")
    file(TO_CMAKE_PATH "$ENV{ZeroMQ_ROOT_DIR}" ZeroMQ_ROOT_DIR)
  else()
    message(FATAL_ERROR "Could not find ZeroMQ_ROOT_DIR environment variable")
  endif(EXISTS "$ENV{ZeroMQ_ROOT_DIR}")

  set(ZMQ_LIBTYPE "dynamic")
  ...
  find_library(ZeroMQ_LIBRARY_RELEASE
    NAMES zmq libzmq
    HINTS ${ZeroMQ_ROOT_DIR}/bin/${CMAKE_VS_PLATFORM_NAME}/Release/${CMAKE_VS_PLATFORM_TOOLSET}/dynamic
    )

  find_library(ZeroMQ_LIBRARY_DEBUG
    NAMES zmq libzmq
    HINTS ${ZeroMQ_ROOT_DIR}/bin/${CMAKE_VS_PLATFORM_NAME}/Debug/${CMAKE_VS_PLATFORM_TOOLSET}/dynamic
    )
